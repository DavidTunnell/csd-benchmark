...
4. **Same AWS identity.** AWS Console and AWS CLI runs both authenticate as the `csd-benchmark-readonly` IAM user defined in `infra/iam-readonly-user.json`. No MFA. CSD runs use a dedicated trial account on production CSD.
